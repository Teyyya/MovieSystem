...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-black dark:bg-black">
        <flux:sidebar sticky stashable class="border-e border-black bg-black dark:border-black dark:bg-black">
    ...
    <a href="{{ route('dashboard') }}" class="me-5 flex items-center space-x-2 rtl:space-x-reverse" wire:navigate>
        ...
        <div class="flex flex-col items-start px-4 py-3 space-y-1">
            {{-- Logo Image Path --}}
            <img src="{{ asset('images/Movieee.png') }}" 
                        ...
                        <div class="p-0 text-sm font-normal">
                            <div class="flex items-center gap-2 px-1 py-1.5 text-start text-sm">
                                <span class="relative flex h-8 w-8 shrink-0 overflow-hidden rounded-lg">
                                    <span
                                        class="flex h-full w-full items-center justify-center rounded-lg bg-black text-white dark:bg-black dark:text-white"
                                    >
                                        {{ auth()->user()->initials() }}
                                    </span>
                                </span>
